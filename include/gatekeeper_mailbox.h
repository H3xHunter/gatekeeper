...
/*
 * In init_mailbox() function, it calls rte_ring_creates(). Notice that,
 ...
 */
int init_mailbox(const char *tag, unsigned ele_count, unsigned ele_size,
	unsigned cache_size, unsigned int lcore_id, struct mailbox *mb);
